...
public class AvaliacaoController {
	...
	@PostMapping
	public ResponseEntity<AvaliacaoDTO> inserirAvaliacao(AvaliacaoDTO avaliacaoDTO) {
		Avaliacao avaliacao = avaliacaoService.inserirAvaliacao(avaliacaoDTO);
		return ResponseEntity.ok(new AvaliacaoDTO(avaliacao));
	}
	
	@PutMapping
	public ResponseEntity<AvaliacaoDTO> alterarAvaliacao(@PathVariable Integer id, AvaliacaoDTO avaliacaoDTO) {
